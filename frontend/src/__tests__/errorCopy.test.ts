...
/**
 * The code -> copy map is the one place an error becomes words. These tests
 * exist so a code cannot ship without copy and quietly fall through to the API's
 * own wording on a display that has room for one line.
 */
