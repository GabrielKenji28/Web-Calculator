...
/**
 * Page shell: brand header, calculator, footer line.
 *
 * `client` is required and injected. The app has no way to construct a
 * fixture-backed client at runtime — the preview adapter lives under `src/test/`
 * and nothing in the application graph imports it — so every answer on screen
 * came from the Go service.
 */
